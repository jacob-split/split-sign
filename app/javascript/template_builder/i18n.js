const en = {
  ...
  mark_editable: 'Mark Editable',
  mark_read_only: 'Mark Read-only',
...
const es = {
  ...
  condition: 'Condición',
  mark_required: 'Marcar obligatorio',
  mark_optional: 'Marcar opcional',
  mark_editable: 'Marcar editable',
  mark_read_only: 'Marcar solo lectura',
  formula: 'Fórmula',
  edit: 'Editar',
...
const it = {
  ...
  mark_required: 'Segna obbligatorio',
  mark_optional: 'Segna facoltativo',
  mark_editable: 'Segna modificabile',
  mark_read_only: 'Segna sola lettura',
...
const pt = {
  ...
  condition: 'Condição',
  mark_required: 'Marcar obrigatório',
  mark_optional: 'Marcar opcional',
  mark_editable: 'Marcar editável',
  mark_read_only: 'Marcar somente leitura',
  formula: 'Fórmula',
  edit: 'Editar',
...
const fr = {
  ...
  options: 'Options',
  condition: 'Condition',
  mark_required: 'Marquer obligatoire',
  mark_optional: 'Marquer facultatif',
  mark_editable: 'Marquer modifiable',
  mark_read_only: 'Marquer lecture seule',
...
const de = {
  ...
  options: 'Optionen',
  condition: 'Bedingung',
  mark_required: 'Als erforderlich markieren',
  mark_optional: 'Als optional markieren',
  mark_editable: 'Als bearbeitbar markieren',
  mark_read_only: 'Als schreibgeschützt markieren',
...
const nl = {
  ...
  mark_required: 'Markeer verplicht',
  mark_optional: 'Markeer optioneel',
  mark_editable: 'Markeer bewerkbaar',
  mark_read_only: 'Markeer alleen-lezen',
