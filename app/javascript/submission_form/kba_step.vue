      ...
      <div class="grid grid-cols-6 gap-x-2 md:gap-x-4 md:gap-y-2 mb-4">
        <div class="col-span-3">
          ...
          <input
            ...
            v-model="form.fn"
            type="text"
            class="input input-bordered !h-10 w-full bg-base-100"
            required
          >
        </div>
        <div class="col-span-3">
        ...
        <div class="col-span-2">
          ...
          <select
            id="kba_state"
            v-model="form.state"
            class="select select-bordered !h-10 min-h-[2.5rem] w-full bg-base-100 font-normal !text-base"
            required
          >
            <option
              value=""
        ...
        <div class="col-span-3">
          ...
          <input
            ...
            v-model="form.dob"
            type="date"
            class="input input-bordered !h-10 md:w-full bg-base-100"
            required
          >
        </div>
        <div class="col-span-3">
