...
module Docuseal
  ...
  PRODUCT_URL = 'https://split-llc.com'
  ...
  TWITTER_URL = 'https://split-llc.com'
  TWITTER_HANDLE = '@split'
  CHATGPT_URL = "#{PRODUCT_URL}/chat".freeze
  SUPPORT_EMAIL = 'support@split-llc.com'
  HOST = ENV.fetch('HOST', 'localhost')
  AATL_CERT_NAME = 'split_sign_aatl'
  CONSOLE_URL = if Rails.env.development?
                  'http://console.localhost.io:3001'
                elsif ENV['MULTITENANT'] == 'true'
                  "https://console.#{HOST}"
                else
                  'https://sign.split-llc.com'
                end
